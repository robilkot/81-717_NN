...
--------------------------------------------------------------------------------
Metrostroi.DefineSystem("81_717_NN_Pneumatic")
...
function TRAIN_SYSTEM:Think(dT)
    ...
    local openR = true
    for i=1,4 do
        self.LeftDoorDir[i] = math.Clamp(self.LeftDoorDir[i]+dT/(self.DoorLeft and self.LeftDoorSpeed[i] or -self.LeftDoorSpeed[i])/2,-1,1)
        self.RightDoorDir[i] = math.Clamp(self.RightDoorDir[i]+dT/(self.DoorRight and self.RightDoorSpeed[i] or -self.RightDoorSpeed[i])/2,-1,1)
